...
export const useAuthStore = create<AuthState>((set) => ({
  ...
  logout: async () => {
    ...
    try {
      console.log('[authStore] calling authRepository.signOut("local") in background...');
      await authRepository.signOut('local');
      console.log('[authStore] authRepository.signOut("local") completed.');
    } catch (e) {
